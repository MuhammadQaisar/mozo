                                ...
                                filteredJobs.map((job, idx) => (
                                    ...
                                    >
                                        <div className="p-6 flex-grow">
                                            <h3 className={`text-2xl font-bold text-gray-900 mb-3 ${urbanist.className}`}>{job.title}</h3>
                                            ...
                                            <p className={`text-gray-600 text-base mb-6 ${urbanist.className}`}>{job.description}</p>
                                        </div>
                                        <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex flex-col justify-center items-center md:w-1/4 md:border-t-0 md:border-l">
                                            <Link href={`/jobs/${job.slug}`} className="py-3 px-8 bg-[#F06A6A] text-white font-semibold rounded-lg hover:bg-[#D05A5A] transition-colors duration-300 mb-2">
                                                Apply Now
                                            </Link>
                                            <Link href={`/jobs/${job.slug}`} className="text-[#F06A6A] font-semibold hover:underline text-sm">
                                                View Details
                                            </Link>
                                        </div>
                                    </motion.div>
