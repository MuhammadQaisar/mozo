...
const faqs = [
    ...
    { question: "What are the benefits of hiring developers through Mozo Technologies?", answer: "Hiring through Mozo Technologies provides access to highly skilled developers without the overhead of traditional recruitment. Benefits include faster hiring cycles, reduced costs, access to specialized expertise, and flexible engagement models tailored to your project requirements." },
    ...
    { question: "Does Mozo Technologies take on project-based work?", answer: "Yes, Mozo Technologies undertakes both project-based work and dedicated team placements. Whether you need a full team to manage a project from conception to completion or individual experts to augment your existing staff, we have flexible solutions to meet your demands." },
