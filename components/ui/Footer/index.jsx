...
<div className="mt-8 flex space-x-4">
            ...
            <ul className="space-y-3">
              {navigationLinks.map((link) => (
                <li key={link.title}>
                  <Link
                    href={link.path}
                    className="text-sm hover:text-white transition-colors pb-1 border-b-2 border-transparent hover:border-[#F06A6A]"
                  >
                    {link.title}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="space-y-4 text-sm">
              <p className="flex items-start">
                <span className="w-5 h-5 mr-3 mt-1 flex-shrink-0">
                  <Image
        ...
        <div className="border-t border-gray-800 mt-16 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-sm text-gray-500 text-center sm:text-left">
            &copy; {currentYear || new Date().getFullYear()} Mozo Technologies.
            All rights reserved.
          </p>
