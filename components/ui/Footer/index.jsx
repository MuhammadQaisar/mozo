            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="lg:col-span-1 text-center md:text-left">
                        ...
                        />
                        <p className="text-gray-400 text-sm leading-relaxed max-w-xl mt-6 text-start">
                        ...
                        <div className="flex mt-6 space-x-2">
                            <input
                                ...
                                className="flex-1 px-2 py-1 mr-2 rounded-md bg-gray-800 border border-gray-700 rounded-l-md focus:outline-none focus:ring-2 focus:ring-[#F06A6A] text-white placeholder-gray-500"
                            />
                            <button className="text-xs px-2 py-1 bg-[#F06A6A] rounded-md hover:bg-red-500 transition-colors">
                                Subscribe
                            </button>
                        </div>
