...
const CTA = () => {
    return (
        <SectionWrapper id="cta" className="py-12 px-8 md:px-16"> {/* Section wrapper for consistent padding and ID for navigation */}
            <motion.div
                ...
                className="relative overflow-hidden rounded-3xl shadow-2xl bg-gradient-to-br from-[#F06A6A] to-red-500 p-6 md:p-12 flex flex-col lg:flex-row items-center justify-between gap-0" // Styling for the CTA card
            >
                ...
                <div className="relative z-10 flex-1 flex flex-col items-center lg:items-start text-center lg:text-left"> {/* Flex container for text content */}
                    <h2 className="text-white text-2xl sm:text-m md:text-l font-extrabold leading-tight mb-0"> {/* Responsive headline styling */}
                        Ready to Transform Your Digital Presence?
                    </h2>
                    <p className="text-white text-base sm:text-m opacity-90 max-w-2xl mx-auto lg:mx-0 mb-0"> {/* Responsive paragraph styling */}
                        Let's build something amazing together. Reach out today to discuss your project and get a free consultation.
                    </p>
                </div>

                {/* CTA Button Area */}
                <div className="relative z-10 flex-shrink-0 -mt-2 lg:mt-0"> {/* Container for the call-to-action button */}
                    <NavLink
