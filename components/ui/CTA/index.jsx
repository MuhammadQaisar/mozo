        ...
        <SectionWrapper id="cta" className="py-12 px-4 md:px-4"> {/* Section wrapper for consistent padding and ID for navigation */}
            ...
            >
                ...
                <div className="relative z-10 flex-1 flex flex-col items-center lg:items-start text-center lg:text-left"> {/* Flex container for text content */}
                    <h2 className="text-white text-2xl sm:text-2xl md:text-4xl font-extrabold leading-tight mb-4"> {/* Responsive headline styling */}
                        Ready to Transform Your Digital Presence?
                    </h2>
                    <p className="text-white text-base sm:text-lg opacity-90 max-w-2xl mx-auto lg:mx-0"> {/* Responsive paragraph styling */}
                ...
                <div className="relative z-10 flex-shrink-0 mt-8 lg:mt-0"> {/* Container for the call-to-action button */}
                    <NavLink
                        ...
                        className="block w-full lg:w-auto px-5 py-2 rounded-full font-bold text-lg text-[#FFFFFF] bg-black shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 ease-in-out" // Styling for the button
                    >
                        BOOK A FREE DEMO
                    </NavLink>
                </div>
