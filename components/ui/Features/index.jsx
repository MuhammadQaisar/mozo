...
const features = [
    ...
    {
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-figma-icon lucide-figma size-8"><path d="M5 5.5A3.5 3.5 0 0 1 8.5 2H12v7H8.5A3.5 3.5 0 0 1 5 5.5z"/><path d="M12 2h3.5a3.5 3.5 0 1 1 0 7H12V2z"/><path d="M12 12.5a3.5 3.5 0 1 1 7 0 3.5 3.5 0 1 1-7 0z"/><path d="M5 19.5A3.5 3.5 0 0 1 8.5 16H12v3.5a3.5 3.5 0 1 1-7 0z"/><path d="M5 12.5A3.5 3.5 0 0 1 8.5 9H12v7H8.5A3.5 3.5 0 0 1 5 12.5z"/></svg>
        ),
        title: "UI/UX",
    ...
    {
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-database-zap-icon lucide-database-zap size-8"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5V19A9 3 0 0 0 15 21.84"/><path d="M21 5V8"/><path d="M21 12L18 17H22L19 22"/><path d="M3 12A9 3 0 0 0 14.59 14.87"/></svg>
        ),
        title: "Data Science",
    ...
    {
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-infinity-icon lucide-infinity size-8"><path d="M6 16c5 0 7-8 12-8a4 4 0 0 1 0 8c-5 0-7-8-12-8a4 4 0 1 0 0 8"/></svg>
        ),
        title: "DevOps",
...
const Features = () => {
    ...
    // Show hovered card info if hovering, else default to web development (index 0)
  ...
  Services
                        ...
                        <div>
                            {/* First row */}
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 w-full max-w-2xl divide-x divide-gray-200">
                                {firstRow.map((item, idx) => (
                                    <div
                                        key={idx}
                                        className="flex flex-col items-center justify-center aspect-square py-6 px-2 tilt-hover group cursor-pointer"
                                        onMouseEnter={() => setHovered(idx)}
                                        onMouseLeave={() => setHovered(null)}
                                    >
                                        <span className="mb-3 transition duration-300 grayscale opacity-50 group-hover:grayscale-0 group-hover:opacity-100">
                                            {item.icon}
                                        </span>
                    ...
                    {/* Right side: Title & Description on hover, no bg or padding */}
                    <div className="lg:mt-40 flex-1 w-full max-w-md mx-auto space-y-6 p-6 bg-white rounded-lg shadow-lg">
